...
-- Focus follows mouse policy (controls behavior to focus windows under
-- the cursor)
ffm = false
...
clientbuttons = gears.table.join(
  awful.button({        }, 1, function (c)
    client.focus = c -- TODO: check condition client.focusable == true
    c:raise()
  end),
...
client.connect_signal("mouse::enter", function(c)
  if ffm and awful.layout.get(c.screen) ~= awful.layout.suit.magnifier
